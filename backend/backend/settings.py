...
SECRET_KEY = os.environ.get('aggregator_secret_key')
...
DATABASES = {
    'default': {
        'ENGINE': os.environ.get('aggregator_db_backend'),
        'NAME': os.environ.get('aggregator_db_name'),
        'USER': os.environ.get('aggregator_db_user'),
        'PASSWORD': os.environ.get('aggregator_db_password'),
        'HOST': os.environ.get('aggregator_db_host'),
        'PORT': os.environ.get('aggregator_db_port'),
    }
}
